...
\authorsLastname{Wallin}
\authorsFirstname{Linus}
\email{liwallin@kth.se}
\kthid{u107775}
...
\supervisorAsLastname{Peters}
\supervisorAsFirstname{Christopher}
\supervisorAsEmail{chpeters@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
\supervisorAsKTHID{u7134}
...
\examinersLastname{Weinkauf}
\examinersFirstname{Tino}
\examinersEmail{weinkauf@kth.se}
% If the examiner is from within KTH add their KTHID, School and Department info
\examinersKTHID{u3641}
