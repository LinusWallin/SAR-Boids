...
Natural catastrophes can cause a lot of destruction to cities and the 
...
\textit{Does the addition of a HLP in the form of an artificial potential field improve the boids algorithm in simulated SAR scenarios.}\\%should I use acronyms in the RQ:s?

The thesis aims to add to the SAR research field by exploring boids aided by an APF HLP taking inspiration from the future work on boids in SAR suggested by Hengstebeck et al.\cite{Hengstebeck2024}.
