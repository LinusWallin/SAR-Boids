...
To see if it is possible to improve the performance of the boids algorithm further Hengstebeck et al.~\cite{Hengstebeck2024} suggested the addition of a HLP to solve the issue of agents becoming stuck by obstacles in the simulation. 
