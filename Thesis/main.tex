...
One of the delimitations for the project will be that it will not consider the movement of the agents

Another delimiation of the project will be that delays in signal processing will not be considered for both the communication between the different agents in the scene
