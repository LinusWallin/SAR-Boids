...
The goal of the thesis is provide insight into the potential of using APF in combination with the \textit{boids algorithm} to find missing people in SAR scenarios with collapsed buildings. 
...
The scope of this project is to explore the potential of using boids affected by an APF in real SAR scenarios with collapsed buildings. 
